...
onMounted(() => {
    createChart(
        stockChart.value.getContext("2d"),
        "bar",
        {
            labels: props.products.map((p) =>
    ...
    createChart(
        salesStatusChart.value.getContext("2d"),
        "bar",
        {
    ...
    createChart(
        purchaseStatusChart.value.getContext("2d"),
        "bar",
        {
    ...
    <AuthenticatedLayout>
        ...
        <main class="py-8 max-w-7xl mx-auto px-6 space-y-12">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                >
                    <h3
                        class="text-xl font-semibold mb-5 border-b border-gray-200 pb-2"
                    >
            ...
            >
                <h3
                    class="text-xl font-semibold mb-5 border-b border-gray-200 pb-2 text-center"
                >
