...
const save = () => {
    if (form.base_qty > 200 || form.in_demand_qty > 200) {
        closeModal();
        Swal.fire({
            icon: "error",
            title: "Invalid Quantity",
            text: "Base Qty and In Demand Qty cannot exceed 200.",
        });
        return;
    }
        ...
        .then((result) => {
            if (result.isConfirmed) {
                form.delete(route("inventories.destroy", inventory), {
                    ...
                    onError: (errors) => {
                        // Show Laravel backend error message in SweetAlert
                        Swal.fire({
                            title: "Delete Failed",
                            text:
                                errors.msg || "Unable to delete this product.",
                            icon: "error",
                        });
                    },
                });
            ...
            <div class="relative flex items-center gap-4">
                ...
                <div class="relative">
                    <button
                        ...
                        class="relative focus:outline-none text-2xl"
                    >
                        🔔
                        <span
                            v-if="
                    ...
                    <div
                        v-if="showDropdown"
                        class="absolute right-0 mt-2 w-72 bg-white border border-gray-200 shadow-lg rounded z-50"
                    >
                        <div class="p-3">
                            <h3
                            ...
                            <div
                                class="text-xs font-semibold text-gray-500 flex justify-between pb-1 border-b"
                            >
                            ...
                            <ul
                                ...
                                class="text-sm divide-y divide-gray-200 max-h-60 overflow-y-auto"
                            >
                                <li
